...
const nextConfig: NextConfig = {
  ...
  images: {
    ...
    /**
     * ภาพที่ย่อแล้วเก็บไว้ 31 วัน (ค่าเริ่มต้นของ Next คือ 4 ชั่วโมง)
     * ไฟล์บน R2 ได้ชื่อใหม่ทุกครั้งที่อัปโหลด เปลี่ยนรูปแล้ว URL ก็เปลี่ยนตาม แคชนานจึงไม่ทำให้เห็นรูปเก่า
     * เดิมภาพใหญ่ถูกย่อซ้ำทุกสี่ชั่วโมง และบางครั้งย่อไม่ทันเจ็ดวินาทีจนหมดเวลา
     */
    minimumCacheTTL: 2_678_400,
    /**
     * ขนาดที่ย่อได้น้อยลง ภาพหนึ่งรูปจึงมีสำเนาน้อยลงและแคชถูกใช้ซ้ำบ่อยขึ้น
     * ตัด 3840 ออก จอ 4K ยังได้ 2560 ซึ่งคมพอสำหรับภาพเต็มจอ
     */
